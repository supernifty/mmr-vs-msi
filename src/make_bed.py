...
# old
#Exon region start (bp)  Exon region end (bp)    Gene start (bp) Gene end (bp)   Chromosome/scaffold name        Gene name       Exon rank in transcript Strand
#66119285        66119659        66119285        66465398        HG991_PATCH     SLC25A26        1       1
